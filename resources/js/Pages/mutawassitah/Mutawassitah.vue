...
const filterByYear = () => {
    router.get(
        route('mutawassitah.Mutawassitah'),
        {
...
const goToPage = () => {
    if (pageInput.value >= 1 && pageInput.value <= students.value.last_page) {
        router.get(
            route('mutawassitah.searchElhaq'),
            {
                page: pageInput.value,
                year: selectedYear.value,
                SRType: selectedSRType.value,
                MElhaq: form.MElhaq  // Remove .value here
            },
            {
                preserveState: true,
                preserveScroll: true,
...
const searchStudent = () => {
    ...
    router.visit(route('mutawassitah.searchElhaq', {
        ...
        <div class="bg-white shadow-xl rounded-xl">
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200">
                ...
                <tr v-for="(student, index) in students.data" :key="student.id" class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 text-md font-semibold whitespace-nowrap">{{ student.MElhaq }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <Link :href="route('mutawassitah.mutawassitaDetailes', { Roll: student.Roll, reg_id: student.reg_id })" class="text-blue-600 hover:text-blue-800 transition-colors duration-150 group">
...
<Link
    v-if="link.url"
    :href="link.url +
        (form.MElhaq ? `&MElhaq=${form.MElhaq}` : '') +
