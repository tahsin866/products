...
const searchStudent = () => {
    ...
    router.visit(route('sanawia.searchElhaq', {
        ...
        <div class="bg-white shadow-xl rounded-xl">
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200">
                ...
                <tr v-for="(student, index) in students.data" :key="student.id" class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <Link :href="route('sanawia.sanawaiaDetailes', { Roll: student.Roll, reg_id: student.reg_id })" class="text-blue-600 hover:text-blue-800 transition-colors duration-150 group">
