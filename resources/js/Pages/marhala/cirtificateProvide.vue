    ...
    <AuthenticatedLayout>
        ...
        <div class="mx-auto p-6">
            ...
            <div v-if="activeTab === 'single'">
                ...
                <div v-if="arabicStudentData && arabicStudentData.length > 0" class="bg-white rounded-xl shadow-lg overflow-hidden mt-5">
...
>
    ...
    >
        ...
        />
                ...
                <div v-else-if="arabicLoading === false && arabicStudentData.length === 0" class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center mt-5">
    ...
    <div v-if="bengaliStudentData?.length > 0" class="space-y-4">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th v-for="header in ['নাম', 'পিতার নাম', 'রোল নম্বর', 'রেজিস্ট্রেশন নম্বর', 'জন্ম-তারিখ', 'ক্লাস', 'একশন']"
                            :key="header"
                            class="px-6 py-4 text-left text-md font-semibold text-gray-600"
                        >
                            {{ header }}
                        </th>
                    </tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="student in bengaliStudentData"
                        :key="student.id"
